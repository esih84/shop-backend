...
export default registerAs('app', () => ({
  ...
  // Loyalty
  pointsPerPurchaseRatio: parseInt(process.env.POINTS_PER_PURCHASE_RATIO || '100', 10),
  ...
  firstPurchaseBonusPoints: parseInt(process.env.FIRST_PURCHASE_BONUS_POINTS || '50', 10),
