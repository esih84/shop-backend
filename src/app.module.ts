  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (config: ConfigService) => ({
        ...
        entities: [
          User, Otp, Category, Product, ProductVariant, ProductImage,
          ProductAttribute, Discount, Review, Cart, CartItem, Order, OrderItem,
          Blog, Banner, Collection, LoyaltyTier, UserLoyalty, PointTransaction,
          Coupon, CouponUsage, Wishlist, Referral, AbandonedCart, ProductView,
        ],
